# 2018-09-09 Retro CV Meter v02 ranges.py
...
neg_led = digitalio.DigitalInOut(board.D3)   # red LED
...
print("2018-09-09 Retro CV Meter v02 ranges.py")
...
while True:
    ...
    if scale_pin.value < 1 * (66535 / 12):
        meter_low = -10
        meter_high = 10
    elif scale_pin.value < 3 * (66535 / 12):
        meter_low = -8
        meter_high = 8
    elif scale_pin.value < 5 * (66535 / 12):
        meter_low = -5
        meter_high = 5
    elif scale_pin.value < 7 * (66535 / 12):
        meter_low = 0
        meter_high = 5
    elif scale_pin.value < 9 * (66535 / 12):
        meter_low = 0
        meter_high = 8
    else:
        meter_low = 0
