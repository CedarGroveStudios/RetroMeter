# 2018-10-02 Meter Tester v01.py
...
#   produces 1.65mA to deflect the meter to full-scale.
#
# 2018-10-02 added recommended 3.3v DAC series resistor and updated DAC and
#   ADC 12-bit maximum values
...
print("2018-10-02 Meter Tester v01.py")
...
while True:
    ...
    if time.monotonic() > t0 + output_hold:
        test_volt = int(((test_volt + map_range(test_pin.value, 0, 65520, 0, 3.3)) / 2)*1000)/1000
        probe_volt = int(((probe_volt + map_range(probe_pin.value, 0, 65520, 0, 3.3)) / 2)*1000)/1000
        ...
        if (test_volt - probe_volt) != 0:
            ...
            meter_resist = 9999999
            new_dac_resist = 9999999
        ...
        if meter_resist != 9999999:
            ...
            print("Recommended 3.3V DAC series resistor (ohms) = ", "%0.1f" % new_dac_resist)
        else:
            print("Meter resistance (ohms)= *infinity*")
            print("Recommended 3.3V DAC series resistor (ohms) = *n/a*")
