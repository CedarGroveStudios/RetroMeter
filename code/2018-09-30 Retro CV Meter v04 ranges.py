# 2018-09-30 Retro CV Meter v04 ranges.py
...
# 2018-09-30 v04 updated to include range potentiometer hysteresis
...
# ctl_idx converts a 16-bit analog value to index integer
#   Input is masked to 8 bits to reduce noise then
#   hysteresis offset is applied. The helper
...
print("2018-09-30 Retro CV Meter v04 ranges.py")
